...
if __name__ == '__main__':
    ...
    prompt_clue = "This is answer"
    
    for ds_name in ["qa_noabs", "qa_reduced"]:
        file_path = f'/home/feic/pjs/Speculative-decoding-database/src/output/prompt_this_is_answer/sd_with_or_without_db_answer_1_70_{ds_name}'
